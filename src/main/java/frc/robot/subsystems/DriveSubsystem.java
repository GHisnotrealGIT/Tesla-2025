...
public class DriveSubsystem extends SubsystemBase {
  ...
  public int initroboconfig() {
    ...
    AutoBuilder.configure(
        ...
        this::resetOdometry, // Method to reset od?ometry (will be called if your auto has a starting pose)
        this::getRobotRelitaveSpeeds, // ChassisSpeeds supplier. MUST BE ROBOT RELATIVE
  ...
  public ChassisSpeeds getRobotRelitaveSpeeds() {
  ...
  /**
   * drive function for pathfinder
   * might want to rename it, but idk it should work anyways.
   */
  public void drive(ChassisSpeeds speeds) {
    // Convert chassis speeds to individual module states
    SwerveModuleState[] swerveModuleStates = DriveConstants.kDriveKinematics.toSwerveModuleStates(speeds);

    // Desaturate wheel speeds to respect max speed
